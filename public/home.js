...
function makePendingApptCard(appt) {
    ...
    `<div class="card" id="appt-${appt['appt_id']}">
        ...
        //move below code to line 23 and line 23 to line 24, commented out to prevent undefined
        // <p>${appt.notes}</p>
...
function makeApptCard(appt, nextAppt) {
    ...
    `<div class="card" id="appt-${appt['appt_id']}">
        ...
        //move below code to line 39 and line 39 to line 40, commented out to prevent undefined
        // <p>${appt.notes}</p>
